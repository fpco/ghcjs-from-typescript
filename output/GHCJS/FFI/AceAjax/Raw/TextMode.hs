module GHCJS.FFI.AceAjax.Raw.TextMode where
...
foreign import javascript "$1.toggleCommentLines($2,$3,$4,$5)" toggleCommentLines :: TextMode -> (GHCJS.JSRef obj0) -> (GHCJS.JSRef obj1) -> (GHCJS.JSRef obj2) -> (GHCJS.JSRef obj3) -> IO (GHCJS.JSRef obj4)
...
foreign import javascript "$1.autoOutdent($2,$3,$4)" autoOutdent :: TextMode -> (GHCJS.JSRef obj0) -> (GHCJS.JSRef obj1) -> (GHCJS.JSRef obj2) -> IO (GHCJS.JSRef obj3)
foreign import javascript "$1.createWorker($2)" createWorker :: TextMode -> (GHCJS.JSRef obj0) -> IO (GHCJS.JSRef obj1)
foreign import javascript "$1.createModeDelegates($2)" createModeDelegates :: TextMode -> (GHCJS.JSRef obj0) -> IO (GHCJS.JSRef obj1)
