module JavaScript.AceAjax.Raw.IEditSession where
...
foreign import javascript "$1.selection" selection :: IEditSession -> IO (Selection)
foreign import javascript "$1.bgTokenizer" bgTokenizer :: IEditSession -> IO (BackgroundTokenizer)
foreign import javascript "$1.doc" doc :: IEditSession -> IO (Document)
foreign import javascript "$1.on($2,$3)" on :: (IEditSession) -> (GHCJS.JSString) -> (GHCJS.JSFun ((GHCJS.JSRef obj0) -> IO (GHCJS.JSRef obj1))) -> IO (())
foreign import javascript "$1.findMatchingBracket($2)" findMatchingBracket :: (IEditSession) -> (Position) -> IO (())
foreign import javascript "$1.addFold($2,$3)" addFold :: (IEditSession) -> (GHCJS.JSString) -> (Range) -> IO (())
foreign import javascript "$1.getFoldAt($2,$3)" getFoldAt :: (IEditSession) -> (GHCJS.JSNumber) -> (GHCJS.JSNumber) -> IO (GHCJS.JSRef obj0)
foreign import javascript "$1.removeFold($2)" removeFold :: (IEditSession) -> (GHCJS.JSRef obj0) -> IO (())
foreign import javascript "$1.expandFold($2)" expandFold :: (IEditSession) -> (GHCJS.JSRef obj0) -> IO (())
foreign import javascript "$1.unfold($2,$3)" unfold :: (IEditSession) -> (GHCJS.JSRef obj0) -> (GHCJS.JSBool) -> IO (())
foreign import javascript "$1.screenToDocumentColumn($2,$3)" screenToDocumentColumn :: (IEditSession) -> (GHCJS.JSNumber) -> (GHCJS.JSNumber) -> IO (())
...
foreign import javascript "$1.highlight($2)" highlight :: (IEditSession) -> (GHCJS.JSString) -> IO (())
foreign import javascript "$1.setDocument($2)" setDocument :: (IEditSession) -> (Document) -> IO (())
foreign import javascript "$1.getDocument()" getDocument :: (IEditSession) -> IO (Document)
foreign import javascript "$1.$resetRowCache($2)" resetRowCache :: (IEditSession) -> (GHCJS.JSNumber) -> IO (())
foreign import javascript "$1.setValue($2)" setValue :: (IEditSession) -> (GHCJS.JSString) -> IO (())
foreign import javascript "$1.setMode($2)" setMode :: (IEditSession) -> (GHCJS.JSString) -> IO (())
...
foreign import javascript "$1.setUndoManager($2)" setUndoManager :: (IEditSession) -> (UndoManager) -> IO (())
...
foreign import javascript "$1.setUseSoftTabs($2)" setUseSoftTabs :: (IEditSession) -> (GHCJS.JSBool) -> IO (())
foreign import javascript "$1.getUseSoftTabs()" getUseSoftTabs :: (IEditSession) -> IO (GHCJS.JSBool)
foreign import javascript "$1.setTabSize($2)" setTabSize :: (IEditSession) -> (GHCJS.JSNumber) -> IO (())
...
foreign import javascript "$1.setOverwrite($2)" setOverwrite :: (IEditSession) -> (GHCJS.JSBool) -> IO (())
foreign import javascript "$1.getOverwrite()" getOverwrite :: (IEditSession) -> IO (GHCJS.JSBool)
foreign import javascript "$1.toggleOverwrite()" toggleOverwrite :: (IEditSession) -> IO (())
foreign import javascript "$1.addGutterDecoration($2,$3)" addGutterDecoration :: (IEditSession) -> (GHCJS.JSNumber) -> (GHCJS.JSString) -> IO (())
foreign import javascript "$1.removeGutterDecoration($2,$3)" removeGutterDecoration :: (IEditSession) -> (GHCJS.JSNumber) -> (GHCJS.JSString) -> IO (())
foreign import javascript "$1.getBreakpoints()" getBreakpoints :: (IEditSession) -> IO (GHCJS.JSArray (GHCJS.JSNumber))
foreign import javascript "$1.setBreakpoints($2)" setBreakpoints :: (IEditSession) -> (GHCJS.JSArray (GHCJS.JSRef obj0)) -> IO (())
foreign import javascript "$1.clearBreakpoints()" clearBreakpoints :: (IEditSession) -> IO (())
foreign import javascript "$1.setBreakpoint($2,$3)" setBreakpoint :: (IEditSession) -> (GHCJS.JSNumber) -> (GHCJS.JSString) -> IO (())
foreign import javascript "$1.clearBreakpoint($2)" clearBreakpoint :: (IEditSession) -> (GHCJS.JSNumber) -> IO (())
foreign import javascript "$1.addMarker($2,$3,$4,$5)" addMarker :: (IEditSession) -> (Range) -> (GHCJS.JSString) -> (Function) -> (GHCJS.JSBool) -> IO (())
foreign import javascript "$1.addMarker($2,$3,$4,$5)" addMarker1 :: (IEditSession) -> (Range) -> (GHCJS.JSString) -> (GHCJS.JSString) -> (GHCJS.JSBool) -> IO (())
foreign import javascript "$1.addDynamicMarker($2,$3)" addDynamicMarker :: (IEditSession) -> (GHCJS.JSRef obj0) -> (GHCJS.JSBool) -> IO (())
foreign import javascript "$1.removeMarker($2)" removeMarker :: (IEditSession) -> (GHCJS.JSNumber) -> IO (())
foreign import javascript "$1.getMarkers($2)" getMarkers :: (IEditSession) -> (GHCJS.JSBool) -> IO (GHCJS.JSArray (GHCJS.JSRef obj0))
foreign import javascript "$1.setAnnotations($2)" setAnnotations :: (IEditSession) -> (GHCJS.JSArray (Annotation)) -> IO (())
foreign import javascript "$1.getAnnotations()" getAnnotations :: (IEditSession) -> IO (GHCJS.JSRef obj0)
foreign import javascript "$1.clearAnnotations()" clearAnnotations :: (IEditSession) -> IO (())
foreign import javascript "$1.$detectNewLine($2)" detectNewLine :: (IEditSession) -> (GHCJS.JSString) -> IO (())
...
foreign import javascript "$1.setNewLineMode($2)" setNewLineMode :: (IEditSession) -> (GHCJS.JSString) -> IO (())
foreign import javascript "$1.getNewLineMode()" getNewLineMode :: (IEditSession) -> IO (GHCJS.JSString)
foreign import javascript "$1.setUseWorker($2)" setUseWorker :: (IEditSession) -> (GHCJS.JSBool) -> IO (())
foreign import javascript "$1.getUseWorker()" getUseWorker :: (IEditSession) -> IO (GHCJS.JSBool)
foreign import javascript "$1.onReloadTokenizer()" onReloadTokenizer :: (IEditSession) -> IO (())
foreign import javascript "$1.$mode($2)" mode :: (IEditSession) -> (TextMode) -> IO (())
foreign import javascript "$1.getMode()" getMode :: (IEditSession) -> IO (TextMode)
foreign import javascript "$1.setScrollTop($2)" setScrollTop :: (IEditSession) -> (GHCJS.JSNumber) -> IO (())
foreign import javascript "$1.getScrollTop()" getScrollTop :: (IEditSession) -> IO (GHCJS.JSNumber)
foreign import javascript "$1.setScrollLeft()" setScrollLeft :: (IEditSession) -> IO (())
...
foreign import javascript "$1.setUndoSelect($2)" setUndoSelect :: (IEditSession) -> (GHCJS.JSBool) -> IO (())
...
foreign import javascript "$1.indentRows($2,$3,$4)" indentRows :: (IEditSession) -> (GHCJS.JSNumber) -> (GHCJS.JSNumber) -> (GHCJS.JSString) -> IO (())
foreign import javascript "$1.outdentRows($2)" outdentRows :: (IEditSession) -> (Range) -> IO (())
...
foreign import javascript "$1.setUseWrapMode($2)" setUseWrapMode :: (IEditSession) -> (GHCJS.JSBool) -> IO (())
foreign import javascript "$1.getUseWrapMode()" getUseWrapMode :: (IEditSession) -> IO (GHCJS.JSBool)
foreign import javascript "$1.setWrapLimitRange($2,$3)" setWrapLimitRange :: (IEditSession) -> (GHCJS.JSNumber) -> (GHCJS.JSNumber) -> IO (())
...
foreign import javascript "$1.$getDisplayTokens($2,$3)" getDisplayTokens :: (IEditSession) -> (GHCJS.JSString) -> (GHCJS.JSNumber) -> IO (())
...
foreign import javascript "$1.documentToScreenRow($2,$3)" documentToScreenRow :: (IEditSession) -> (GHCJS.JSNumber) -> (GHCJS.JSNumber) -> IO (())
